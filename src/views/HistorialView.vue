...
<template>
  <div class="wrap fade-up">
    ...
    <p v-else-if="!ventas.length" class="dim state-msg">
      No se registran transacciones devengadas en el periodo contable.
    </p>
    ...
    <Teleport to="body">
      <div v-if="seleccionada" class="modal-bg" @click.self="seleccionada = null">
        <div class="modal card">
          ...
          <button class="btn btn-ghost btn-block" @click="seleccionada = null">
            Cerrar Registro
          </button>
        </div>
      </div>
...
.det-items::-webkit-scrollbar {
  width: 4px;
}
.det-items::-webkit-scrollbar-track {
  background: transparent;
}
.det-items::-webkit-scrollbar-thumb {
...
/* Cambios de Responsividad Optimizados */
